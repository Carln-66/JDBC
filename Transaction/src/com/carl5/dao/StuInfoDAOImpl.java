 ...
 */
public class StuInfoDAOImpl extends DAO implements StuInfoDAO{
    @Override
    ...
    public StuInfo getstuInfoById(Connection connection, int id) {
        ...
        StuInfo stu = getInstance(connection, StuInfo.class, sql, id);
        return stu;
    }
    ...
    public List<StuInfo> getAll(Connection connection) {
        ...
        List<StuInfo> list = getForList(connection, StuInfo.class, sql);
        return list;
    }
